...
//	}
	...
	private void previousMenuItem() {
		...
		if (this.returnCode == 0)
			this.returnCode = 6; // from 'Exit' to '2 player mode' (Starter) // Team Clover changed values because recordMenu added // Hong changed values because Achievement added
